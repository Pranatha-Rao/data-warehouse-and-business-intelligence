...
GO
---------------------------------------
CREATE TABLE [DimEmployeeDepartment](
	EmpDepID int not null,
	[EmployeeID] int not null,
	[DepartmentID] INT NOT NULL,
	
 CONSTRAINT [PK_DimEmployeeDepartment] PRIMARY KEY CLUSTERED 
(
	EmpDepID ASC
))
GO
...
GO
ALTER TABLE [dbo].[DimVendorContact]  WITH CHECK ADD  CONSTRAINT [FK_VendorKey] FOREIGN KEY([VendorKey])
REFERENCES [dbo].[DimVendors] ([VendorKey])
GO
ALTER TABLE [dbo].[DimVendorContact]  WITH CHECK ADD  CONSTRAINT [FK_V[ContactTypeIDKey] FOREIGN KEY([ContactTypeID])
...
ALTER TABLE [dbo].FactPurchase  WITH CHECK ADD  CONSTRAINT [FK_geokey] FOREIGN KEY (geokey)
REFERENCES [dbo].[DimGeography] (geokey)
GO
ALTER TABLE [dbo].FactPurchase  WITH CHECK ADD  CONSTRAINT [FK_ProductID] FOREIGN KEY (ProductID)
REFERENCES [dbo].[DimProducts_Purchased] (ProductID)
GO